...
bernoulli_model <- tinystan_model(file.path(
  stan_folder,
  "bernoulli",
  "bernoulli.stan"
))
...
gaussian_model <- tinystan_model(file.path(
  stan_folder,
  "gaussian",
  "gaussian.stan"
))
...
multimodal_model <- tinystan_model(file.path(
  stan_folder,
  "multimodal",
  "multimodal.stan"
))
simple_jacobian_model <- tinystan_model(file.path(
  stan_folder,
  "simple_jacobian",
