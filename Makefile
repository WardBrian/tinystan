...
TORSTEN_INCLUDE = -I $(TORSTEN) -include $(TORSTEN)torsten_include.hpp
...
$(PRECOMPILED_MODEL_HEADER): $(STAN)src/stan/model/model_header.hpp
	...
	@mkdir -p $(dir $@)
	$(COMPILE.cpp) $(TORSTEN_INCLUDE) $< $(OUTPUT_OPTION)
...
%.o : %.hpp $(USER_HEADER) $(PRECOMPILED_MODEL_HEADER)
	...
	$(COMPILE.cpp) $(TORSTEN_INCLUDE) $(PRECOMPILED_HEADER_INCLUDE) $(USER_INCLUDE) -x c++ -o $(subst  \,/,$*).o $(subst \,/,$<)
